...
const AddBlog = () => {
    ...
    const [blog, setBlog] = useState({ title: undefined, description: undefined, img: null, fill: null});
                    ...
                    <div className="">
                        <form onChange={handleFormChange} onSubmit={handleFormSubmit}>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="file" className="form-control" accept="img/*" id="img" name="file" required />
                            </div>
