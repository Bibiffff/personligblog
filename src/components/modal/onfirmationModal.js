const ConfirmationModal = ({ title = "Remember Title", message = "Remember Message", onConfirm = () => alert("Remember OnConfirm")}) => {
    return (
        <>
            ...
            <div className="modal fade" id="confirmationModal" tabIndex="-1" aria-labelledby="confirmationModalLabal" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-danger" data-bs-dismiss="modal" onClick={onConfirm}>Comfirm</button>
                        </div>
                    </div>
                </div>
            </div>
